...
function renderPostList() {
    ...
    posts.forEach(post => {
        ...
        <button class="delete" onclick= "deletePost(${post.id})">Eliminar</button>

        <div id="editForm-${post.id}" class="editForm" style="display: none;">
            <label for="editTitle">Título:</label>
...
function deletePost(id) {
    fetch(`${urlBase}/${id}`, {
        ...
        .catch(error => console.error('Error al borrar el posteo', error))
}
